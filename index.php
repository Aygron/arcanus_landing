...
<head>
    ...
    <meta property="og:url" content="https://arcanusonline.com/">
    ...
    <meta property="og:image" content="https://arcanusonline.com/img/arcanus_logo.png">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://arcanusonline.com/">
    ...
    <main>
        <section id="hero">
            <div class="hero-content">
                ...
                <p>¡Unite a nuestra comunidad de Discord y enterate de todas las novedades y anuncios!</p>
                <a href="https://discord.com/invite/Eqg7zmVj2f" target="_blank" class="btn btn-large discord-button">
        ...
        <section id="features" class="container">
            ...
            <div class="features-grid">
                ...
                <div class="feature-item">
                    ...
                    <p>Forma tu clan, forja alianzas y lucha por el control de castillos y territorios en batallas masivas.</p>
                </div>
                <div class="feature-item">
                    <i class="fas fa-hat-wizard"></i>
                    <h3>Clases y Roles</h3>
                    <p>Elige entre clases icónicas como Paladín, Mago, Asesino o Bardo y domina habilidades únicas.</p>
                </div>
                <div class="feature-item">
                    <i class="fas fa-map-marked-alt"></i>
                    <h3>Mundo Abierto</h3>
                    <p>Explora un vasto mundo sin restricciones, lleno de ciudades, mazmorras y tesoros ocultos.</p>
                </div>
                <div class="feature-item">
