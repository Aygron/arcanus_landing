...
<body>
    ...
    <main class="container">
        <section class="legal-content">
            ...
            <p>Por favor lea atentamente estas políticas de uso antes de iniciar la utilización de las Cuentas Premium.</p>
            <p>Mediante el uso de nuestro servicio, usted declara conocer, aceptar y estar sujeto a las disposiciones que a continuación se detallan, y a los términos y condiciones generales establecidos en el presente documento.</p>
            <p>Arcanus Online (en adelante, el "Sitio") se reserva el derecho de modificar total o parcialmente estos términos y condiciones en cualquier momento, sin necesidad de notificación previa. El uso continuado del servicio implica la aceptación plena de dichas modificaciones.</p>

            <h2>2 - Obligaciones para el usuario</h2>
            <p>El usuario se compromete a no utilizar el Sitio, sus productos, servicios o la Cuenta Premium con el objetivo de perjudicar, interferir o atentar contra el correcto funcionamiento e intereses del Sitio.</p>

            <h3>2.1 - Cuenta Premium</h3>
            <p>Una Cuenta Premium es un acceso personalizado, asociado a un nombre de cuenta, contraseña y PIN, que habilita al usuario a funciones adicionales dentro del servicio. El usuario se compromete a no divulgar sus datos de acceso y a utilizar una dirección de correo electrónico personal y válida. Estos elementos son necesarios para la seguridad y recuperación de la cuenta.</p>

            <h3>2.2 - Condiciones de validez de una cuenta</h3>
            <p>Una Cuenta Premium no será considerada válida si no cumple con los siguientes requisitos mínimos:</p>
            <ul>
            ...
            <p>Toda controversia derivada de la interpretación o ejecución de estos Términos y Condiciones será resuelta por los tribunales ordinarios con competencia en la Ciudad de Córdoba, renunciando el usuario a cualquier otro fuero o jurisdicción que pudiera corresponder.</p>
